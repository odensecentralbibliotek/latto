...
<div<?php if (!empty($css_id)) { print " id=\"$css_id\""; } ?>>
  <div class="grid-row">
    <div class="grid-10-left">
      <div class="grid-inner"><?php print $content['grid_10_top_left']; ?></div>
    </div>
    <aside class="grid-3-center-right">
      <div class="grid-inner"><?php print $content['grid_3_top_center_right']; ?></div>
    </aside>
  ...
  <div class="grid-row last">
    <div class="grid-10-right">
      <div class="grid-inner"><?php print $content['grid_10_bottom_right']; ?></div>
    </div>
    <aside class="grid-3-left">
      <div class="grid-inner"><?php print $content['grid_3_bottom_left']; ?></div>
    </aside>
    <aside class="grid-3-center-left">
      <div class="grid-inner"><?php print $content['grid_3_bottom_center_left']; ?></div>
    </aside>
  </div>
</div>